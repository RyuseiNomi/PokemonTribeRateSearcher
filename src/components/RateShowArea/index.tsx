    ...
    return (
      <div className="chart">
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.h/255)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.a/181)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.b/230)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.c/173)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.d/230)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.s/200)*100} status="active" showInfo={false}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <Progress percent={(this.props.pokemon.total/720)*100} status="active" showInfo={false}/>
          </Col>
